...
const Header = () => {
  ...
  return (
    <>
      <header className="fixed top-0 w-full z-30 bg-white-500 transition-all shadow-md">
        <nav className="max-w-screen-xl px-6 mx-auto grid grid-flow-col py-3 sm:px-8 lg:px-16 sm:py-4">
          <div className="col-start-1 col-end-2 flex items-center w-auto">
            <Image src={LogoHeader} alt="Tailwind Play" />
          </div>
          ...
          <div className="col-start-10 col-end-12 font-medium flex justify-end items-center">
            <ButtonWP className="inline">
              ...
              <a href="https://wa.me/573053255769">Contactenos</a>
            </ButtonWP>
          </div>
        </nav>
      </header>
